...
file_paths = ["/opt/render/project/src/data/DocMovi_Data.pdf"] ## path in local: "/home/leocisal/python_bot/python-whatsapp-bot/data/DocMovi_Data.pdf"  production: /opt/render/project/src/data/DocMovi_Data.pdf
